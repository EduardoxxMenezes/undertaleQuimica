...
function criarObstaculoGrandeVertical(from) {
  ...
  obstaculo.style.width = "40px";
  obstaculo.style.height = "75px";
...
function criarObstaculoGrandeHorizontal(from) {
  const obstaculo = document.createElement("div");
  obstaculo.classList.add("obstaculo-grande");
  obstaculo.style.width = "75px";
  obstaculo.style.height = "40px";
  ...
  const velocidade = from === "left" ? 6 : -6;
